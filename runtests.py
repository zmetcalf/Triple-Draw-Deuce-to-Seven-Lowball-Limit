...
def suite():
    ...
    suite.addTest(Lowball27HandRankControllerTests('testGetLowballWinner'))
    ...
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfFullHouseFalse'))
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfFlushTrue'))
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfFlushFalse'))
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfStraightTrue'))
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfStraightFalse'))
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfThreeOfKindTrue'))
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfThreeOfKindFalse'))
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfTwoPairedTrue'))
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfTwoPairedFalse'))
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfPairedTrue'))
    suite.addTest(Lowball27HandRankControllerTests('testCheckIfPairedFalse'))
